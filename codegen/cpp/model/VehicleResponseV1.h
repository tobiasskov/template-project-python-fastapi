...
#ifndef VehicleResponseV1_H_
#define VehicleResponseV1_H_
...
/// Base response schema including ID (V1).
/// </summary>
class  VehicleResponseV1
{
public:
    VehicleResponseV1();
    virtual ~VehicleResponseV1() = default;
    ...
    bool operator==(const VehicleResponseV1& rhs) const;
    bool operator!=(const VehicleResponseV1& rhs) const;

    /////////////////////////////////////////////
    /// VehicleResponseV1 members
    ...
    friend  void to_json(nlohmann::json& j, const VehicleResponseV1& o);
    friend  void from_json(const nlohmann::json& j, VehicleResponseV1& o);
protected:
    std::string m_Make;
