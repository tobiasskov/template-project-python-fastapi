...
#ifndef TruckCreateV1_H_
#define TruckCreateV1_H_
...
public:
    ...
    bool operator==(const TruckCreateV1& rhs) const;
    bool operator!=(const TruckCreateV1& rhs) const;

    /////////////////////////////////////////////
    /// TruckCreateV1 members
    ...
    friend  void to_json(nlohmann::json& j, const TruckCreateV1& o);
    friend  void from_json(const nlohmann::json& j, TruckCreateV1& o);
protected:
    std::string m_Make;
